...
" 11/12/30 Akira Torii 
" edited
" indent_guides_color_change_percent 10 to 30
"	indent_guides_guide_size 0 to 1
call s:InitVariable('g:indent_guides_indent_levels',         30)
call s:InitVariable('g:indent_guides_auto_colors',           1 )
call s:InitVariable('g:indent_guides_color_change_percent',  10) " ie. 30%
